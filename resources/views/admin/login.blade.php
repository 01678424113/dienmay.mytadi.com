...
{{Html::style('cms/assets/global/css/components.min.css')}}
{{Html::style('cms/assets/global/css/plugins.min.css')}}
{{Html::style('cms/assets/pages/css/login.css')}}
{{Html::favicon(env('APP_FAVICON'))}}
<body class="login">
<div class="content">
    {!! Form::open(['action' => 'Admin\AccessController@doLogin', 'method' => 'POST', 'class'=> 'login-form']) !!}
    <h3 class="form-title font-red-soft uppercase">ĐIỆN MÁY</h3>
    <div id="alerts"></div>
