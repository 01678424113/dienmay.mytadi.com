...
<div class="portlet light">
    ...
    <div class="portlet-body form">
        {!! Form::open(['action' => 'Admin\ArticleController@doAddArticle', 'method' => 'POST', 'id'=> 'article-form', 'files' => true]) !!}
        <div class="form-body">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="form-group" >
                        ...
                        <textarea class="form-control" name="txt-summary" rows="3"></textarea>
                    </div>
                    <div class="form-group" >
                        <label class="control-label">Nội dung</label>
                        <textarea class="form-control" name="txt-content"></textarea>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
    ...
    $(document).ready(function () {
        $('#article-form').validate({
            ...
            messages: {
                ...
                'sl-category': {
                    required: "Chuyên mục tin tức không hợp lệ",
